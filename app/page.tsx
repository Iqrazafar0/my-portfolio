            ...
            {myProjects.map((project, index) => (
              <div key={index} className="project-item" style={{ marginBottom: '50px' }}>
                ...
                <div style={{ marginTop: '15px', display: 'flex', gap: '10px' }}>
                  ...
                  <a href={project.githubLink} target="_blank" className="download-btn" style={{ padding: '8px 15px', fontSize: '0.6rem', background: 'transparent', color: '#1a3c34 !important' , opacity: '1' }}>GitHub</a>
                </div>
